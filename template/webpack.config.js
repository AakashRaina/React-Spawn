...
const webpackConfig = env => merge.smart({ mode: env.mode }, webpackBaseConfig(), envConfig(env));

const envConfig = ({ mode }) => mode === 'development' ? webpackDevConfig() : webpackProdConfig();
